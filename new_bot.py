...
class DialogBot(object):
    ...
    def __init__(self, token, generator):
        self.updater = Updater(token="424882927:AAGKLtBw6ZmZyQQH9mfSKVpztQO6LxzyNX8")  # заводим апдейтера
    ...
    #     answer = yield "Ай-яй-яй. %s, фу таким быть! Что именно вам так не нравится?"
    #     likes_article = yield from ask_yes_or_no("Ваша позиция имеет право на существование. Статья на Хабре вам, надо полагать, тоже не понравилась?")
    #     if likes_article:
